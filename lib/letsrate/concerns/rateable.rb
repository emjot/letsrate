...
module Letsrate
  ...
  module Rateable
    ...
    included do
      ...
      has_one   :rate_average_without_dimension, :as => :cacheable, :class_name => "RatingCache", :dependent => :destroy, :conditions => {:dimension => nil}

      self.extend ClassMethods
      include RateableInstanceMethods
    end

    module ClassMethods

      # Defines further associations for one or multiple rating dimensions.
      def rateable_dimensions(*dimensions)
